...
- New option `responseFactory` (only in `Reader`) to configure a custom factory implementing `Psr\Http\Message\ResponseFactoryInterface`
...
[1.1.0]: https://github.com/middlewares/filesystem/compare/v1.0.0...HEAD
